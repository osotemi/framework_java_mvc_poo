...
public class Controler_mainClient implements ActionListener, KeyListener, MouseListener, FocusListener{
    ...
    public void run(){
        ...
        MainClient.btn_formClt_Avatar.addKeyListener(this);
        ...
        MainClient.CB_formClt_state.addKeyListener(this);
